...
\def\AcceptedG{{\color{green}Accepted\xspace}}
\def\AcceptedR{{\color{red}Accepted\xspace}}
\def\RejectedG{{\color{green}Rejected\xspace}}
\def\RejectedR{{\color{red}Rejected\xspace}}
...
\begin{longtabu} to \textwidth {||c | c c c c c c ||}
  ...
  \endlastfoot
    ...
    No Common Name & Accepted & Accepted & Accepted & Accepted & Accepted & Accepted\\
    No Subject & Accepted & Rejected & Accepted & Rejected & Accepted & Rejected\\
    ...
    Static RSA & \AcceptedR & \AcceptedR & \AcceptedR & \AcceptedR & \AcceptedR & \AcceptedR\\
