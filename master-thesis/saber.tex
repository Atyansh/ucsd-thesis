...
behavior for certificates in \Cref{tab:results-table-saber} in the appendix.
...
\Cref{fig:prototype-saber} shows the design for this approach.
...
can be found in \Cref{tab:results-table-saber} in the appendix.
